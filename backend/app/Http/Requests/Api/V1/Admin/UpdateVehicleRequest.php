...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'license_plate' => ['required', 'string', 'max:20', Rule::unique('vehicles', 'license_plate')->ignore($vehicleId)],
            'vin' => ['nullable', 'string', 'max:20', Rule::unique('vehicles', 'vin')->ignore($vehicleId)],
